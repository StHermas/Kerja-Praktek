<?php 
	...
	if( isset($_POST['submit'])) {
		...
		$query 				= "INSERT INTO tbl_warga VALUES ('$id', '$tanggal', '$idpelanggan', '$kdpaket', $qty, $biaya, $bayar, $kembalian)";
		...
		<div class="card-body">
			...
			<form method="post" action="">
				<div class="form-group row">
					<label for="id" class="col-sm-2 col-form-label">Kode Keluarga</label>
					<div class="col-sm-10">
